...
7. If you want to select a different shader, open the `Shaders` menu again, and select your preferred settings/shaders. When you are satisfied, select the `Save` button, and click `Save Content Directory Preset`
...
8. Back out to the `Quick Menu`, click `Overrides`, and click `Save Content Directory Overrides`
